...
import (
	...
	clientv1beta1 "k8s.io/client-go/kubernetes/typed/apps/v1"
...
func CreateDeployment(client clientv1beta1.DeploymentInterface, deployment *appsv1.Deployment) error {
...
func NewDeployment(i DeploymentInput) *appsv1.Deployment {
